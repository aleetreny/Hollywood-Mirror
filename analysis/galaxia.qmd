...
```{python}
#| label: tbl-isolation-tails
#| tbl-cap: "Isolation tails in embedding space: top five most isolated scripts versus top five most conformist scripts."
#| output: asis
...
The left column (*Top 5 Most Original*) captures the high-isolation end of the distribution, where atypical scripts such as *Velvet Buzzsaw*, *Shrek the Third*, *The Disaster Artist*, and *The Damned United* stand out. The right column (*Top 5 Most Conformist*) captures the low-isolation end and is dominated by **Harry Potter** entries, indicating exceptionally tight semantic similarity within that franchise.
...
The resulting map confirms the topological validity of the UMAP reduction. True isolation in 768 dimensions maps perfectly to the physical geography of the 2D projection. The bright yellow "flares" of unclassifiable art, the experiments, satires, and structural anomalies, orbit on the extreme outer rim of the cinematic galaxy, looking inwards at the dense, indistinguishable cores of Hollywood's generic machine.
